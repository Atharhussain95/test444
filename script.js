...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const startWithoutAudioButton = document.getElementById('startWithoutAudio');
    ...
    // Show or hide the start button based on the session storage
    if (!hasLoadedThisSession) {
        startButton.style.display = 'block'; // Show the start button
        startWithoutAudioButton.style.display = 'block'; // Show the 'Enter Without Audio' button
    } else {
        startButton.style.display = 'none'; // Hide the start button if already loaded
        startWithoutAudioButton.style.display = 'none'; // Hide the 'Enter Without Audio' button if already loaded
    }
    ...
    startWithoutAudioButton.addEventListener('click', function () {
        startLoader(false);
    });

    function startLoader(playAudio) {
        // Hide the start buttons
        startButton.style.display = 'none';
        startWithoutAudioButton.style.display = 'none';
